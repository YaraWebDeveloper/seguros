...
<?php
/* * Elemewntos PHP* */
$dataInput = controlInput('tip_usu_nombre', $valorNombre, 'Nombre Tipo Ocupación', 'required form-control');
                        ...
                        <table id="table_general" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($Registros as $itemTipoOcupacion):
                                    echo ' 
                                <tr>
                                    <td> ' . $itemTipoOcupacion->tip_usu_nombre . ' </td>
                                    <td> ' . reemplazarEstado($itemTipoOcupacion->est_id) . ' </td>
                                    <td> <a href="' . base_url($this->uri->segment(1) . "/editarTipoUsuario/" . $itemTipoOcupacion->tip_usu_id) . '">Editar</a> </td>
                                </tr>
                                ';
        ...
        <div class="box box-solid box-warning">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    if ($valorId != NULL):
                        ?>
                        <a href="<?php echo base_url($this->uri->segment(1)); ?>" class="btn btn-danger">Cancelar</a>
                        <?php
                    endif;
                    ?>
                </div>
