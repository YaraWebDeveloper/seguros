...
<?php
/* * Elemewntos PHP* */
$dataInput = controlInput('usu_rol_nombre', $valorNombre, 'Nombre Rol', 'required form-control');
                        ...
                        <table id="table_general" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="' . base_url($this->uri->segment(1) . "/editarRol/" . $itemRol->usu_rol_id) . '"><i class="fa fa-pencil"></i> Editar</a> </td>
                                </tr>
                                ';
        ...
        <div class="box box-solid box-warning">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_hidden('usu_rol_id', $valorId) ?>
